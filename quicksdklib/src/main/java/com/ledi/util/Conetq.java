...
public class Conetq {
    ...
    public static String login_uid = "";//用户唯一标识
    ...
    //vivo
    public static String vivoChannelInfo="";//vivo用户安装信息来源
...
//	public static String TerraceUrl5 = "http://testapi.44755.com/cpgame/init";
    ...
    public static String getP_icon_name = "com/ledi";
...
//	public static String logininfo ="http://www.44755.com/user-api_cplogintest";//测试地址
    ...
    public static String phoneTel = "";//弹窗获取到的手机号
	public static String gameVersion = "";//cp传过来的游戏版本号
